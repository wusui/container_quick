...
#
export latestversion=${latestversion:-'2.2.8-1'}
export lastansible=${lastansible:-'2.2.3.0-1'}
...
sudo rpm -ivh http://download-node-02.eng.bos.redhat.com/rcm-guest/ceph-drops/auto/rhscon-2-rhel-7-compose/latest-RHSCON-2-RHEL-7/compose/Installer/x86_64/os/Packages/ansible-${lastansible}.el7.noarch.rpm
